                ...
                <div class="col">
                    <div class="card h-100 ">
                        ...
                        <div class="card-body text-start">
                            ...
                            <Link  to='/projects1'><button type="button" class="btn btn-secondary btn-sm ">Details</button> </Link>
                ...
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-body text-start">
                            ...
                            <Link  to='/projects2'><button type="button" class="btn btn-secondary btn-sm ">Details</button></Link>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-body text-start">
                            ...
                            <Link  to='/projects3'><button type="button" class="btn btn-secondary btn-sm ">Details</button></Link>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-body text-start">
                            ...
                            <Link  to='/projects4'><button type="button" class="btn btn-secondary btn-sm ">Details</button> </Link>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-body text-start">
                           ...
                           <a href="https://amithasan102827.github.io/Assignment-1/"><button type="button" class="btn btn-success btn-sm mx-3">Live Site</button></a>
                            ...
                            <Link  to='/projects5'><button type="button" class="btn btn-secondary btn-sm ">Details</button></Link>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-body text-start">
                            ...
                            <Link  to='/projects6'><button type="button" class="btn btn-secondary btn-sm ">Details</button></Link>
                        </div>
                    </div>
                </div>
            </div>
